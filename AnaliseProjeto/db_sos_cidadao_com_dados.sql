...
INSERT INTO tbnivelacesso (idNivelAcesso, nmNivelAcesso)
VALUES (1,'Usuário');

INSERT INTO tbpessoa (idPessoa, nmPessoa, cpfPessoa, rgPessoa, dtNascimento, telefonePessoa, 
					  login, senha, emailPessoa, tokenRecuSenha, fkIdNivelAcesso)
VALUES (1,'Maria','000.000.000-00', '111111', '1990-01-01', '999999999', 'MariaL',
		'123', 'maria@gmail.com', '1234', 1);

INSERT INTO tbstatusocorrencia(idStatusOcorrencia, nmStatusOcorrencia)
VALUES (1, 'ABERTO');

INSERT INTO tblocal(idLocal, nmLocal, latitudeLocal, longitudeLocal)
VALUES (1, 'RUA A', 26.4, 108.2);

INSERT INTO tbocorrencia (idOcorrencia, dataOcorrencia, descOcorrencia, fkIdStatusOcorrencia, 
                fkIdLocal, fkIdPessoaSolicitante)
VALUES (1, '2020-11-30', 'Furto de um celular', 1, 1, 1)